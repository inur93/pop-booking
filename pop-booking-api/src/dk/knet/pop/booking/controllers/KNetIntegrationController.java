...
public class KNetIntegrationController {
	...
	private final String targetUrl =  ConfigManager.read(ConfigManager.K_NET_API_URL);// "https://k-net.dk/api/v2/network/";
	...
	private final String username = ConfigManager.read(ConfigManager.USERNAME);
	private final String password = ConfigManager.read(ConfigManager.PASSWORD);
